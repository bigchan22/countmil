...
\begin{itemize}
  \item Sequential finite-support convolution accumulates shifted copies of the current PMF and is used for binary, signed, and ordinal-sum experiments.
  ...
  \item Balanced FFT-tree convolution multiplies the atomic polynomials pairwise and is used for runtime experiments and multiclass one-vs-rest histogram/PVC likelihoods.
\end{itemize}
...
FFT-tree & finite support / OVR & $O(CT\log T\log n)$ & runtime, PVC-style histograms \\
\bottomrule
\end{tabular}
\end{table}
